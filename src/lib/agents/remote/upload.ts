...
export const UPLOAD_REJECTION_MESSAGES: Record<UploadRejection, string> = {
  ...
  "drive-relative": "TabDump can't resolve one of those paths with confidence.",
  "unsupported-character": "One of those file names has a character TabDump can't use.",

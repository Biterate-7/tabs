...
export function buildOrganizePrompt(sections: Section[], tabs: OrganizePromptTab[]): string {
  ...
  return [
    ...
    "- Subcategory: a specific subject or workstream inside a category (e.g. \"Physics\", \"Hubble\", \"Economics\").",
    ...
    "",
    "NAMING",
    "- Names must be short, clean, human-readable nouns or noun phrases (e.g. \"Physics\", \"Hubble\", \"S2 Orbit Research\"). Never vague or padded names like \"Miscellaneous Physics\", \"Physics Resources & Materials\", \"Random Research\", \"Web Things\", or \"Other Research\".",
